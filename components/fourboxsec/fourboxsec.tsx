...
const cardData = [
  {
    ...
    description: 'Comfortable and stylish oversized T-shirts suitable for everyone. Perfect for a relaxed and trendy look.',
  ...
  },
  {
    ...
    description: 'Elegantly crafted for women, these half sleeve round neck tees blend comfort with contemporary fashion.',
  ...
  },
  {
    ...
    description: 'Durable and smart polo shirts ideal for professional or industrial work environments.',
  ...
  },
  {
    ...
    description: 'Classic and versatile round neck tees for men. A wardrobe essential for any occasion.',
  ...
  {cardData.map((card, index) => (
    ...
    >
      ...
      <Box
        sx={{
          height: '25vh',
          backgroundImage: 'url(/banner/c6794aca-1c7e-49bd-89d4-316ab2580393.jpeg)',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundAttachment: 'fixed',
        }}
