...
// Constants
const tshirtColors = ['Royal Blue', 'White', 'Black', 'Navy Blue', 'Red'];
      ...
      <Box sx={{ p: 3, backgroundColor: isDarkMode ? '#121212' : '#fff', minHeight: '100vh' }}>
        <Box display="flex" justifyContent="center" width="100%">
          <Typography variant="h4" gutterBottom>
            Design Round Neck Female T-shirt
          </Typography>
        </Box>
            ...
            >
              <Box
                sx={{
                  width: '100%',
                  height: '100%',
                  backgroundImage: `url(/round-neck-women-tshirts/${color.toLowerCase().replace(/\s+/g, '_')}_front.png)`,
            ...
            >
              <Box
                sx={{
                  width: '100%',
                  height: '100%',
                  backgroundImage: `url(/round-neck-women-tshirts/${color.toLowerCase().replace(/\s+/g, '_')}_back.png)`,
                  backgroundSize: 'contain',
                  backgroundRepeat: 'no-repeat',
                  backgroundPosition: 'center',
                  filter: dragging ? 'brightness(0.9)' : 'none',
